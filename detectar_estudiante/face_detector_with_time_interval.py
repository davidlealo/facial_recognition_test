...
# Diccionario para almacenar la última vez que una persona fue registrada
last_detection_time = {}

# Intervalo de tiempo mínimo entre detecciones (en segundos)
time_interval = 5  # 5 segundos
...
with open('detections.csv', mode='a', newline='') as file:
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            # Verificar si se debe registrar la detección
            if name not in last_detection_time or (current_time - last_detection_time[name]).total_seconds() > time_interval:
